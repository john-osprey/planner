# December 2025 - Week 1 Plan (Dec 1-7)
...
### Morning
- [ ] **Breakfast**: Oatmeal with berries and flaxseed (Day 3)
- [ ] **Microsoft prep**: Draft conflict disclosure document
- [ ] **YNAB**: Set up Q1 2026 estimated tax category ($28,000)
...
### Morning
- [ ] **Breakfast**: Oatmeal with orange slices (Day 4)
- [ ] **YNAB**: Download mobile app, practice entering transactions
- [ ] **Microsoft prep**: Begin Microsoft ecosystem research (org structure, marketing division)
...
### Morning
- [ ] **Breakfast**: Overnight oats (easy morning)
- [ ] **Microsoft prep**: Explore learn.microsoft.com, bookmark relevant courses
- [ ] **YNAB**: First account reconciliation
...
### Morning
- [ ] **First family training check-in**: Breakfast/hot chocolate with boys
  - Discuss upcoming training program
  - Get their excitement/concerns
  - Set expectations for first week
- [ ] **YNAB**: Review full week's spending
- [ ] **Food tracking**: Calculate weekly saturated fat average
...
### Morning
- [ ] **FIRST FAMILY RUN!**: 10-20 min easy run with boys, you continue after
- [ ] **Post-run**: Special breakfast together, celebrate first run
- [ ] **YNAB**: Full Sunday budget review (15-20 min)
...
**Must Complete:**
- [x] Oatmeal breakfast 5+ days
- [x] Food tracking every day in MyFitnessPal
- [x] YNAB account set up and current
- [x] First family training meeting held
- [x] Two family bodyweight sessions completed
- [x] First family run on Sunday
...
## Week 1 (Dec 1-7): LAUNCH
**Theme**: Establish new routines

**Priorities:**
1. Start daily oatmeal breakfast habit
2. Begin food tracking (baseline saturated fat & fiber)
3. Reactivate and set up YNAB
4. Launch family training program
5. Begin Microsoft conflict disclosure
6. First family run on Sunday

**Training:**
- Family: Intro meeting, 2x bodyweight strength, 1x family run
- Dad: Continue marathon training, lead family sessions
- Boys: Ease into routine, make it fun
...
## Week 3 (Dec 15-21): MICROSOFT WEEK 1 + MAINTAIN
**Theme**: New job integration while maintaining health habits

**Priorities:**
1. **MICROSOFT FIRST WEEK** - Primary focus
2. Maintain morning oatmeal (quick prep)
3. Continue food tracking (simpler meals OK)
4. YNAB: Quick daily tracking, Sunday review
5. Family training: 2x strength (shorter OK), Sunday run
6. Be flexible with schedule due to new job

**Training:**
- Family: Maintain 2x strength, Sunday run (keep commitments)
- Dad: Adjust marathon training if needed for new job fatigue
- Remember: Consistency > perfection

**Food:**
- Keep it simple: Oatmeal breakfast, bean bowls for easy lunches
- Track but don't stress about perfection
- Stock easy healthy options

**YNAB:**
- Track first Microsoft paycheck
- Budget accordingly
- Quick updates, full review Sunday

---

## Week 4 (Dec 22-28): HOLIDAY WEEK
**Theme**: Maintain core habits during holidays

**Priorities:**
1. Microsoft: Lighter work week (likely half days or time off)
2. Family time: Primary focus
3. Maintain training: 2x strength, 1x family run
4. Food tracking: Continue but be realistic about holiday meals
5. YNAB: Track holiday spending
6. Enjoy family, don't stress perfection

**Notes:**
- Christmas Day (Dec 25): Rest for all, family focus
- Flexible training schedule
- Maintain oatmeal breakfast on normal days
- Bean meals where appropriate
- Allow holiday treats without guilt, just track

---

## Week 5 (Dec 29-31 + Jan 1-4): YEAR-END TRANSITION
**Theme**: Close December strong, prepare for January

**End of December (Dec 29-31):**
- [ ] Microsoft: Likely light work or time off
- [ ] Family training: 1-2 sessions (flexible)
- [ ] YNAB: December month-end review with Katie
- [ ] Food: Return to routine after holidays
- [ ] Reflect on December progress

**New Year (Jan 1-4):**
- [ ] Set January intentions for all projects
- [ ] Microsoft: Return to Week 2-3 routine
- [ ] Training: Resume full schedule (2x strength, Sunday run)
- [ ] YNAB: Set up January budget
- [ ] Food: Full routine restored
...
## Health & Nutrition
**Saturated Fat:**
- [ ] Track food intake 25+ days
- [ ] Calculate baseline saturated fat (Week 1)
- [ ] Reduce by 20% from baseline by month-end
- [ ] Implement 5-10 permanent food swaps
- [ ] Get cholesterol labs (baseline)

**Soluble Fiber:**
- [ ] Oatmeal breakfast 25+ days in December
- [ ] Include beans in 12-15 meals (3-4x per week)
- [ ] Average 8-10g soluble fiber per day by month-end
- [ ] Establish shopping routine for fiber foods

## Family & Training
**Family Training:**
- [ ] Hold kickoff meeting with boys
- [ ] Complete 6-8 family bodyweight sessions
- [ ] Complete 4 family Sunday runs
- [ ] Hold 4 Saturday morning check-in conversations
- [ ] Zero injuries for anyone
- [ ] Boys report enjoying the experience

**Marathon Training:**
- [ ] Maintain training plan through Microsoft start
- [ ] Integrate family sessions smoothly
- [ ] Build toward 50 miles/week by month-end
- [ ] Adjust as needed for new job demands

## Financial
**YNAB:**
- [ ] Account fully set up and current
- [ ] All accounts linked and reconciling
- [ ] Daily transaction tracking established
- [ ] Weekly Sunday review habit established
- [ ] Katie actively participating
- [ ] First monthly budget meeting held (Dec 31)
- [ ] Q1 2026 tax category created and funding started

## Professional
**Microsoft Preparation (Dec 1-13):**
- [ ] Conflict disclosure completed and approved
- [ ] Microsoft ecosystem familiarized
- [ ] Marketing metrics reviewed
- [ ] learn.microsoft.com explored
- [ ] First-week goals defined and ready
- [ ] All pre-start paperwork completed

**Microsoft Week 1 (Dec 14-20):**
- [ ] Successfully complete first week
...
**2024 Tax Forms:**
- [ ] Set reminder for Q1 2026 estimated tax (due 1/15/26)
- [ ] Schedule meeting with Larry Torella for 2025-2026 planning

---

# December Weekly Rhythm

**EVERY WEEK IN DECEMBER:**

### Sunday
- Morning: Family easy run (10-20 min for boys)
- Dad continues long run solo
- Afternoon: YNAB budget review (15-20 min)
- Evening: Prep for week ahead

### Tuesday & Thursday
- Evening: Family bodyweight strength (15-20 min)

### Saturday
- Morning: Training check-in conversation with boys over breakfast
- Throughout day: Marathon training, meal prep, project work

### Daily
- Morning: Oatmeal breakfast (with apple, berries, or orange)
- Throughout: Track food in MyFitnessPal
- Throughout: Track spending in YNAB
- Evening: Log and reconcile

---

# Critical December Dates

**December 1 (Sun)**: Month starts, new habits begin
**December 6 (Sat)**: First family training check-in
**December 7 (Sun)**: First family run together
**December 13 (Fri)**: Last day before Microsoft
**December 14 (Sat)**: MICROSOFT START DATE
**December 25 (Wed)**: Christmas - family rest day
**December 31 (Tue)**: Month-end YNAB review with Katie

---

# Success Metrics for December

**By December 31, consider December successful if:**

✅ Oatmeal breakfast habit established (20+ days)
✅ Food tracking consistent (25+ days)
✅ YNAB active and current
✅ Family training: 6+ sessions completed, boys enjoying it
✅ Microsoft: Strong first 2 weeks, positive impression
✅ Saturated fat reduced from baseline
✅ Soluble fiber averaging 8-10g/day
✅ Zero injuries for anyone
✅ Katie participating in YNAB
✅ Conflict disclosure approved
✅ Q1 2026 tax category funded on track
...
- New job takes priority during first weeks
- Health habits are long-term, not one-month sprints

---

*Created: November 30, 2025*
*For: December 1-31, 2025*
